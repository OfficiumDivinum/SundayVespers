\no{2}\evenverse Sitívit in te áni\textit{ma} \textbf{me}a,~\*\\
...
\no{4}\evenverse Quóniam mélior est misericórdia tua su\textit{per} \textbf{vi}tas:~\*\\
\evenverse lábia me\textit{a} \textit{lau}\textbf{dá}bunt te.\\
\no{5}\oddverse Sic benedícam te in vi\textit{ta} \textbf{me}a:~\*\\
\oddverse et in nómine tuo levábo \textit{ma}\textit{nus} \textbf{me}as.\\
\no{6}\evenverse Sicut ádipe et pinguédine repleátur áni\textit{ma} \textbf{me}a:~\*\\
