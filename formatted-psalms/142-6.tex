\no{2}\evenverse Et non intres in judícium cum ser\textit{vo} \textbf{tu}o:~\*\\
\evenverse quia non justificábitur in conspéctu tuo \textit{om}\textit{nis} \textbf{vi}vens.\\
\no{3}\oddverse Quia persecútus est inimícus áni\textit{mam} \textbf{me}am:~\*\\
...
\no{6}\evenverse Expándi manus me\textit{as} \textbf{ad} te:~\*\\
\evenverse ánima mea sicut terra sine \textit{a}\textit{qua} \textbf{ti}bi.\\
\no{7}\oddverse Velóciter exáudi \textit{me}, \textbf{Dó}mine:~\*\\
\oddverse defécit spí\textit{ri}\textit{tus} \textbf{me}us.\\
\no{8}\evenverse Non avértas fáciem tu\textit{am} \textbf{a} me:~\*\\
\evenverse et símilis ero descendénti\textit{bus} \textit{in} \textbf{la}cum.\\
\no{9}\oddverse Audítam fac mihi mane misericórdi\textit{am} \textbf{tu}am:~\*\\
\oddverse quia in \textit{te} \textit{spe}\textbf{rá}vi.\\
\no{10}\evenverse Notam fac mihi viam, in \textit{qua} \textbf{ám}bulem:~\*\\
\evenverse quia ad te levávi á\textit{ni}\textit{mam} \textbf{me}am.\\
\no{11}\oddverse Eripe me de inimícis meis, Dómine, ad te \textit{con}\textbf{fú}gi:~\*\\
\oddverse doce me fácere voluntátem tuam, quia Deus \textit{me}\textit{us} \textbf{es} tu.\\
\no{12}\evenverse Spíritus tuus bonus dedúcet me in ter\textit{ram} \textbf{re}ctam:~\*\\
\evenverse propter nomen tuum, Dómine, vivificábis me, in æqui\textit{tá}\textit{te} \textbf{tu}a.\\
\no{13}\oddverse Edúces de tribulatióne áni\textit{mam} \textbf{me}am:~\*\\
\oddverse et in misericórdia tua dispérdes ini\textit{mí}\textit{cos} \textbf{me}os.\\
\no{14}\evenverse Et perdes omnes, qui tríbulant áni\textit{mam} \textbf{me}am,~\*\\
