...
\no{4}\evenverse Dixi iníquis: Nolíte i\textbf{ní}que \textbf{á}\textbf{ge}re:~\*\\
...
\no{6}\evenverse Quia neque ab Oriénte, neque ab Occidénte, neque a de\textbf{sér}tis \textbf{món}\textbf{ti}bus:~\*\\
...
\no{9}\oddverse Ego autem annunti\textbf{á}bo in \textbf{sǽ}\textbf{cu}lum:~\*\\
