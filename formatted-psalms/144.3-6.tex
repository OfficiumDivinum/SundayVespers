\no{2}\evenverse Allevat Dóminus omnes \textit{qui} \textbf{cór}ruunt:~\*\\
\evenverse et érigit om\textit{nes} \textit{e}\textbf{lí}sos.\\
\no{3}\oddverse Oculi ómnium in te spe\textit{rant}, \textbf{Dó}mine:~\*\\
\oddverse et tu das escam illórum in témpore \textit{op}\textit{por}\textbf{tú}no.\\
\no{4}\evenverse Aperis tu ma\textit{num} \textbf{tu}am:~\*\\
\evenverse et imples omne ánimal bene\textit{di}\textit{cti}\textbf{ó}ne.\\
\no{5}\oddverse Justus Dóminus in ómnibus vi\textit{is} \textbf{su}is:~\*\\
\oddverse et sanctus in ómnibus opé\textit{ri}\textit{bus} \textbf{su}is.\\
\no{6}\evenverse Prope est Dóminus ómnibus invocánti\textit{bus} \textbf{e}um:~\*\\
...
\no{8}\evenverse Custódit Dóminus omnes di\textit{li}\textbf{gén}tes se:~\*\\
\evenverse et omnes peccató\textit{res} \textit{di}\textbf{spér}det.\\
\no{9}\oddverse Laudatiónem Dómini loquétur \textit{os} \textbf{me}um:~\*\\
