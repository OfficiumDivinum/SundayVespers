\no{2}\evenverse Custódi ánimam meam, \textbf{quó}niam \textbf{san}\textbf{ctus} sum:~\*\\
...
\no{7}\oddverse Non est símilis tui in \textbf{di}is, \textbf{Dó}\textbf{mi}ne:~\*\\
\oddverse et non est secúndum \textbf{ó}pera \textbf{tu}a.\\
\no{8}\evenverse Omnes gentes quascúmque fecísti, vénient, et adorábunt \textbf{co}ram te, \textbf{Dó}\textbf{mi}ne:~\*\\
\evenverse et glorificábunt \textbf{no}men \textbf{tu}um.\\
\no{9}\oddverse Quóniam magnus es tu, et fáciens \textbf{mi}ra\textbf{bí}\textbf{li}a:~\*\\
...
\no{12}\evenverse Quia misericórdia tua \textbf{ma}gna est \textbf{su}\textbf{per} me:~\*\\
...
\no{14}\evenverse Et tu, Dómine, Deus miserátor \textbf{et} mi\textbf{sé}\textbf{ri}cors,~\*\\
