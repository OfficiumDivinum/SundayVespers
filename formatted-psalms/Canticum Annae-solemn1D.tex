...
\no{4}\evenverse Nolíte multiplicáre \textit{lo}\textit{qui} \textit{su}\textbf{blí}\textbf{mi}a,~\*\\
...
\no{6}\evenverse Arcus fórti\textit{um} \textit{su}\textit{pe}\textbf{rá}\textbf{tus} est,~\*\\
...
\no{8}\evenverse Donec stérilis \textit{pé}\textit{pe}\textit{rit} \textbf{plú}\textbf{ri}mos:~\*\\
\evenverse et quæ multos habébat fílios, \textit{in}\textit{fir}\textbf{má}ta est.\\
\no{9}\oddverse Dóminus mortífi\textit{cat} \textit{et} \textit{vi}\textbf{ví}\textbf{fi}cat,~\*\\
...
\no{12}\evenverse Ut séde\textit{at} \textit{cum} \textit{prin}\textbf{cí}\textbf{pi}bus,~\*\\
