...
\no{12}\evenverse Quóniam defécit in dolóre vi\textit{ta} \textbf{me}a:~\*\\
\evenverse et anni mei \textit{in} \textit{ge}\textbf{mí}tibus.\\
\no{13}\oddverse Infirmáta est in paupertáte vir\textit{tus} \textbf{me}a:~\*\\
\oddverse et ossa mea \textit{con}\textit{tur}\textbf{bá}ta sunt.\\
\no{14}\evenverse Super omnes inimícos meos factus sum oppróbrium et vicínis me\textit{is} \textbf{val}de:~\*\\
\evenverse et timor \textit{no}\textit{tis} \textbf{me}is.\\
\no{15}\oddverse Qui vidébant me, foras fugé\textit{runt} \textbf{a} me:~\*\\
\oddverse oblivióni datus sum, tamquam mórtu\textit{us} \textit{a} \textbf{cor}de.\\
\no{16}\evenverse Factus sum tamquam \textit{vas} \textbf{pér}ditum:~\*\\
\evenverse quóniam audívi vituperatiónem multórum commorántium \textit{in} \textit{cir}\textbf{cú}itu.\\
\no{17}\oddverse In eo dum convenírent simul \textit{ad}\textbf{vér}sum me,~\*\\
...
\no{19}\oddverse Eripe me de manu inimicórum \textit{me}\textbf{ó}rum,~\*\\
...
\no{21}\oddverse Erubéscant ímpii, et deducántur in \textit{in}\textbf{fér}num:~\*\\
\oddverse muta fiant lábi\textit{a} \textit{do}\textbf{ló}sa.\\
\no{22}\evenverse Quæ loquúntur advérsus justum ini\textit{qui}\textbf{tá}tem:~\*\\
\evenverse in supérbia, et in a\textit{bu}\textit{si}\textbf{ó}ne.\\
\no{23}\oddverse Quam magna multitúdo dulcédinis tu\textit{æ}, \textbf{Dó}mine,~\*\\
\oddverse quam abscondísti ti\textit{mén}\textit{ti}\textbf{bus} te.\\
\no{24}\evenverse Perfecísti eis, qui spe\textit{rant} \textbf{in} te,~\*\\
\evenverse in conspéctu fili\textit{ó}\textit{rum} \textbf{hó}minum.\\
\no{25}\oddverse Abscóndes eos in abscóndito facié\textit{i} \textbf{tu}æ~\*\\
\oddverse a conturbati\textit{ó}\textit{ne} \textbf{hó}minum.\\
\no{26}\evenverse Próteges eos in tabernácu\textit{lo} \textbf{tu}o~\*\\
\evenverse a contradictió\textit{ne} \textit{lin}\textbf{guá}rum.\\
\no{27}\oddverse Benedí\textit{ctus} \textbf{Dó}minus:~\*\\
\oddverse quóniam mirificávit misericórdiam suam mihi in civitá\textit{te} \textit{mu}\textbf{ní}ta.\\
\no{28}\evenverse Ego autem dixi in excéssu men\textit{tis} \textbf{me}æ:~\*\\
\evenverse Projéctus sum a fácie oculó\textit{rum} \textit{tu}\textbf{ó}rum.\\
\no{29}\oddverse Ideo exaudísti vocem oratió\textit{nis} \textbf{me}æ,~\*\\
...
\no{31}\oddverse Viríliter ágite, et confortétur \textit{cor} \textbf{ve}strum,~\*\\
\oddverse omnes, qui sperá\textit{tis} \textit{in} \textbf{Dó}mino.\\
\no{32}\evenverse Glória Patri, \textit{et} \textbf{Fí}lio,~\*\\
\evenverse et Spirí\textit{tu}\textit{i} \textbf{San}cto.\\
\no{33}\oddverse Sicut erat in princípio, et nunc, \textit{et} \textbf{sem}per,~\*\\
