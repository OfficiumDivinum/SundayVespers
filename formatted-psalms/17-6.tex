\no{2}\evenverse Deus meus adjú\textit{tor} \textbf{me}us,~\*\\
\evenverse et sperá\textit{bo} \textit{in} \textbf{e}um.\\
\no{3}\oddverse Protéctor meus, et cornu salú\textit{tis} \textbf{me}æ,~\*\\
\oddverse et su\textit{scép}\textit{tor} \textbf{me}us.\\
\no{4}\evenverse Laudans invocá\textit{bo} \textbf{Dó}minum:~\*\\
\evenverse et ab inimícis meis \textit{sal}\textit{vus} \textbf{e}ro.\\
\no{5}\oddverse Circumdedérunt me doló\textit{res} \textbf{mor}tis:~\*\\
\oddverse et torréntes iniquitátis con\textit{tur}\textit{ba}\textbf{vé}runt me.\\
\no{6}\evenverse Dolóres inférni circum\textit{de}\textbf{dé}runt me:~\*\\
\evenverse præoccupavérunt me lá\textit{que}\textit{i} \textbf{mor}tis.\\
\no{7}\oddverse In tribulatióne mea invocá\textit{vi} \textbf{Dó}minum,~\*\\
\oddverse et ad Deum me\textit{um} \textit{cla}\textbf{má}vi.\\
\no{8}\evenverse Et exaudívit de templo sancto suo vo\textit{cem} \textbf{me}am:~\*\\
\evenverse et clamor meus in conspéctu ejus, introívit in \textit{au}\textit{res} \textbf{e}jus.\\
\no{9}\oddverse Commóta est, et contrému\textit{it} \textbf{ter}ra:~\*\\
...
\no{11}\oddverse Inclinávit cælos, et \textit{de}\textbf{scén}dit:~\*\\
\oddverse et calígo sub pé\textit{di}\textit{bus} \textbf{e}jus.\\
\no{12}\evenverse Et ascéndit super Chérubim, et \textit{vo}\textbf{lá}vit:~\*\\
...
\no{14}\evenverse Præ fulgóre in conspéctu ejus nubes tran\textit{si}\textbf{é}runt,~\*\\
...
\no{16}\evenverse Et misit sagíttas suas, et dissipá\textit{vit} \textbf{e}os:~\*\\
\evenverse fúlgura multiplicávit, et contur\textit{bá}\textit{vit} \textbf{e}os.\\
\no{17}\oddverse Et apparuérunt fontes \textit{a}\textbf{quá}rum,~\*\\
\oddverse et reveláta sunt fundaménta or\textit{bis} \textit{ter}\textbf{rá}rum:\\
\no{18}\evenverse Ab increpatióne tu\textit{a}, \textbf{Dó}mine,~\*\\
\evenverse ab inspiratióne spíritus \textit{i}\textit{ræ} \textbf{tu}æ.\\
\no{19}\oddverse Misit de summo, et \textit{ac}\textbf{cé}pit me:~\*\\
...
\no{21}\oddverse Prævenérunt me in die afflictió\textit{nis} \textbf{me}æ:~\*\\
\oddverse et factus est Dóminus pro\textit{té}\textit{ctor} \textbf{me}us.\\
\no{22}\evenverse Et edúxit me in la\textit{ti}\textbf{tú}dinem:~\*\\
\evenverse salvum me fecit, quóniam \textit{vó}\textit{lu}\textbf{it} me.\\
\no{23}\oddverse Et retríbuet mihi Dóminus secúndum justíti\textit{am} \textbf{me}am:~\*\\
\oddverse et secúndum puritátem mánuum meárum retrí\textit{bu}\textit{et} \textbf{mi}hi:\\
\no{24}\evenverse Quia custodívi vi\textit{as} \textbf{Dó}mini,~\*\\
\evenverse nec ímpie gessi a \textit{De}\textit{o} \textbf{me}o.\\
\no{25}\oddverse Quóniam ómnia judícia ejus in conspé\textit{ctu} \textbf{me}o:~\*\\
\oddverse et justítias ejus non ré\textit{pu}\textit{li} \textbf{a} me.\\
\no{26}\evenverse Et ero immaculátus \textit{cum} \textbf{e}o:~\*\\
\evenverse et observábo me ab iniqui\textit{tá}\textit{te} \textbf{me}a.\\
\no{27}\oddverse Et retríbuet mihi Dóminus secúndum justíti\textit{am} \textbf{me}am:~\*\\
\oddverse et secúndum puritátem mánuum meárum in conspéctu ocu\textit{ló}\textit{rum} \textbf{e}jus.\\
\no{28}\evenverse Cum sancto san\textit{ctus} \textbf{e}ris,~\*\\
\evenverse et cum viro innocénte ín\textit{no}\textit{cens} \textbf{e}ris:\\
\no{29}\oddverse Et cum elécto elé\textit{ctus} \textbf{e}ris:~\*\\
\oddverse et cum pervérso \textit{per}\textit{ver}\textbf{té}ris.\\
\no{30}\evenverse Quóniam tu pópulum húmilem sal\textit{vum} \textbf{fá}cies:~\*\\
\evenverse et óculos superbórum hu\textit{mi}\textit{li}\textbf{á}bis.\\
\no{31}\oddverse Quóniam tu illúminas lucérnam me\textit{am}, \textbf{Dó}mine:~\*\\
\oddverse Deus meus, illúmina té\textit{ne}\textit{bras} \textbf{me}as.\\
\no{32}\evenverse Quóniam in te erípiar a tenta\textit{ti}\textbf{ó}ne,~\*\\
...
\no{34}\evenverse Quóniam quis Deus præ\textit{ter} \textbf{Dó}minum?~\*\\
\evenverse aut quis Deus præter \textit{De}\textit{um} \textbf{no}strum?\\
\no{35}\oddverse Deus, qui præcínxit me \textit{vir}\textbf{tú}te:~\*\\
\oddverse et pósuit immaculátam \textit{vi}\textit{am} \textbf{me}am.\\
\no{36}\evenverse Qui perfécit pedes meos tamquam \textit{cer}\textbf{vó}rum,~\*\\
\evenverse et super excélsa \textit{stá}\textit{tu}\textbf{ens} me.\\
\no{37}\oddverse Qui docet manus meas \textit{ad} \textbf{prǽ}lium:~\*\\
\oddverse et posuísti, ut arcum ǽreum, brá\textit{chi}\textit{a} \textbf{me}a.\\
\no{38}\evenverse Et dedísti mihi protectiónem salú\textit{tis} \textbf{tu}æ:~\*\\
\evenverse et déxtera tu\textit{a} \textit{su}\textbf{scé}pit me:\\
\no{39}\oddverse Et disciplína tua corréxit me \textit{in} \textbf{fi}nem:~\*\\
\oddverse et disciplína tua ipsa \textit{me} \textit{do}\textbf{cé}bit.\\
\no{40}\evenverse Dilatásti gressus me\textit{os} \textbf{sub}tus me:~\*\\
\evenverse et non sunt infirmáta vestí\textit{gi}\textit{a} \textbf{me}a:\\
\no{41}\oddverse Pérsequar inimícos meos et comprehén\textit{dam} \textbf{il}los:~\*\\
\oddverse et non convértar, do\textit{nec} \textit{de}\textbf{fí}ciant.\\
\no{42}\evenverse Confríngam illos, nec póte\textit{runt} \textbf{sta}re:~\*\\
\evenverse cadent subtus \textit{pe}\textit{des} \textbf{me}os.\\
\no{43}\oddverse Et præcinxísti me virtúte \textit{ad} \textbf{bel}lum:~\*\\
\oddverse et supplantásti insurgéntes \textit{in} \textit{me} \textbf{sub}tus me.\\
\no{44}\evenverse Et inimícos meos dedísti mi\textit{hi} \textbf{dor}sum,~\*\\
\evenverse et odiéntes me di\textit{sper}\textit{di}\textbf{dí}sti.\\
\no{45}\oddverse Clamavérunt, nec erat qui salvos fáceret \textit{ad} \textbf{Dó}minum:~\*\\
\oddverse nec exau\textit{dí}\textit{vit} \textbf{e}os.\\
\no{46}\evenverse Et commínuam illos, ut púlverem ante fáci\textit{em} \textbf{ven}ti:~\*\\
\evenverse ut lutum plateárum de\textit{lé}\textit{bo} \textbf{e}os.\\
\no{47}\oddverse Erípies me de contradictióni\textit{bus} \textbf{pó}puli:~\*\\
\oddverse constítues me in \textit{ca}\textit{put} \textbf{gén}tium.\\
\no{48}\evenverse Pópulus quem non cognóvi serví\textit{vit} \textbf{mi}hi:~\*\\
\evenverse in audítu auris obe\textit{dí}\textit{vit} \textbf{mi}hi.\\
\no{49}\oddverse Fílii aliéni mentíti \textit{sunt} \textbf{mi}hi,~\*\\
\oddverse fílii aliéni inveteráti sunt, et claudicavérunt a sé\textit{mi}\textit{tis} \textbf{su}is.\\
\no{50}\evenverse Vivit Dóminus, et benedíctus De\textit{us} \textbf{me}us:~\*\\
\evenverse et exaltétur Deus sa\textit{lú}\textit{tis} \textbf{me}æ.\\
\no{51}\oddverse Deus, qui das vindíctas mihi, et subdis pópu\textit{los} \textbf{sub} me:~\*\\
\oddverse liberátor meus de inimícis meis \textit{i}\textit{ra}\textbf{cún}dis.\\
\no{52}\evenverse Et ab insurgéntibus in me e\textit{xal}\textbf{tá}bis me:~\*\\
\evenverse a viro iníquo e\textit{rí}\textit{pi}\textbf{es} me.\\
\no{53}\oddverse Proptérea confitébor tibi in natióni\textit{bus}, \textbf{Dó}mine:~\*\\
...
\no{55}\oddverse Glória Patri, \textit{et} \textbf{Fí}lio,~\*\\
\oddverse et Spirí\textit{tu}\textit{i} \textbf{San}cto.\\
\no{56}\evenverse Sicut erat in princípio, et nunc, \textit{et} \textbf{sem}per,~\*\\
