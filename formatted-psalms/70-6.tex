...
\no{14}\evenverse Confundántur, et defíciant detrahéntes áni\textit{mæ} \textbf{me}æ:~\*\\
\evenverse operiántur confusióne et pudóre, qui quærunt \textit{ma}\textit{la} \textbf{mi}hi.\\
\no{15}\oddverse Ego autem semper \textit{spe}\textbf{rá}bo:~\*\\
\oddverse et adjíciam super omnem \textit{lau}\textit{dem} \textbf{tu}am.\\
\no{16}\evenverse Os meum annuntiábit justíti\textit{am} \textbf{tu}am:~\*\\
...
\no{18}\evenverse Deus, docuísti me a juventú\textit{te} \textbf{me}a:~\*\\
\evenverse et usque nunc pronuntiábo mirabí\textit{li}\textit{a} \textbf{tu}a.\\
\no{19}\oddverse Et usque in senéctam \textit{et} \textbf{sé}nium:~\*\\
\oddverse Deus, ne \textit{de}\textit{re}\textbf{lín}quas me,\\
\no{20}\evenverse Donec annúntiem bráchi\textit{um} \textbf{tu}um~\*\\
...
\no{23}\oddverse Multiplicásti magnificénti\textit{am} \textbf{tu}am:~\*\\
\oddverse et convérsus conso\textit{lá}\textit{tus} \textbf{es} me.\\
\no{24}\evenverse Nam et ego confitébor tibi in vasis psalmi veritá\textit{tem} \textbf{tu}am:~\*\\
\evenverse Deus, psallam tibi in cíthara, \textit{San}\textit{ctus} \textbf{Is}raël.\\
\no{25}\oddverse Exsultábunt lábia mea cum cantáve\textit{ro} \textbf{ti}bi:~\*\\
\oddverse et ánima mea, quam \textit{re}\textit{de}\textbf{mí}sti.\\
\no{26}\evenverse Sed et lingua mea tota die meditábitur justíti\textit{am} \textbf{tu}am:~\*\\
\evenverse cum confúsi et revériti fúerint, qui quærunt \textit{ma}\textit{la} \textbf{mi}hi.\\
\no{27}\oddverse Glória Patri, \textit{et} \textbf{Fí}lio,~\*\\
\oddverse et Spirí\textit{tu}\textit{i} \textbf{San}cto.\\
\no{28}\evenverse Sicut erat in princípio, et nunc, \textit{et} \textbf{sem}per,~\*\\
