...
{5.~}Quia ipse dixit, et \textbf{fa}cta sunt:~* ipse mandávit, \textit{et} \textit{cre}\textbf{á}ta sunt.\\
{6.~}Státuit ea in ætérnum, et in sǽculum \textbf{sǽ}culi:~* præcéptum pósuit, et non \textit{præ}\textit{te}\textbf{rí}bit.\\
...
{12.~}Júvenes, et vírgines,~† senes cum junióribus laudent nomen \textbf{Dó}mini:~* quia exaltátum est nomen e\textit{jus} \textit{so}\textbf{lí}us.\\
