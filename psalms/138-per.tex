...
{13.~}Confitébor tibi quia terribíliter magnificátus es:~† mirabília \textit{ó}\textit{pe}\textit{ra} \textbf{tu}a,~* et ánima mea cognó\textit{scit} \textbf{ni}mis.\\
{14.~}Non est occultátum os meum a te, quod fecí\textit{sti} \textit{in} \textit{oc}\textbf{cúl}to:~* et substántia mea in inferióri\textit{bus} \textbf{ter}ræ.\\
{15.~}Imperféctum meum vidérunt óculi tui,~† et in libro tuo \textit{om}\textit{nes} \textit{scri}\textbf{bén}tur:~* dies formabúntur, et nemo \textit{in} \textbf{e}is.\\
{16.~}Mihi autem nimis honorificáti sunt amí\textit{ci} \textit{tu}\textit{i}, \textbf{De}us:~* nimis confortátus est principátus \textit{e}\textbf{ó}rum.\\
