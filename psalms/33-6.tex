...
{15.~}Oculi Dómini su\textit{per} \textbf{ju}stos:~* et aures ejus in pre\textit{ces} \textit{e}\textbf{ó}rum.\\
...
{19.~}Multæ tribulatiónes \textit{ju}\textbf{stó}rum:~* et de ómnibus his liberábit \textit{e}\textit{os} \textbf{Dó}minus.\\
{20.~}Custódit Dóminus ómnia ossa \textit{e}\textbf{ó}rum:~* unum ex his non \textit{con}\textit{te}\textbf{ré}tur.\\
{21.~}Mors peccató\textit{rum} \textbf{pés}sima:~* et qui odérunt ju\textit{stum}, \textit{de}\textbf{lín}quent.\\
