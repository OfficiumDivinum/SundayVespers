...
{3.~}Deduc me in sémitam mandató\textit{rum} \textit{tu}\textbf{ó}rum:~* qui\textit{a} \textit{i}\textit{psam} \textbf{vó}\textbf{lu}i.\\
{4.~}Inclína cor meum in testimó\textit{ni}\textit{a} \textbf{tu}a:~* et non \textit{in} \textit{a}\textit{va}\textbf{rí}\textbf{ti}am.\\
...
{12.~}Et custódiam legem \textit{tu}\textit{am} \textbf{sem}per:~* in sǽculum et in \textit{sǽ}\textit{cu}\textit{lum} \textbf{sǽ}\textbf{cu}li.\\
