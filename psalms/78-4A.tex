{2.~}Posuérunt morticína servórum tuórum, escas volatí\textit{li}\textit{bus} \textbf{cæ}li:~* carnes sanctórum tuórum \textit{bé}\textit{sti}\textit{is} \textbf{ter}ræ.\\
...
{4.~}Facti sumus oppróbrium vi\textit{cí}\textit{nis} \textbf{no}stris:~* subsannátio et illúsio his, qui in cir\textit{cú}\textit{i}\textit{tu} \textbf{no}stro sunt.\\
...
{14.~}Nos autem pópulus tuus, et oves pá\textit{scu}\textit{æ} \textbf{tu}æ,~* confitébimur \textit{ti}\textit{bi} \textit{in} \textbf{sǽ}culum.\\
