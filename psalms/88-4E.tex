...
{8.~}Deus, qui glorificátur in consíli\textit{o} \textit{san}\textbf{ctó}rum:~* magnus et terríbilis super omnes qui in cir\textit{cú}\textit{i}\textit{tu} \textbf{e}\textbf{jus} sunt.\\
...
{10.~}Tu domináris pote\textit{stá}\textit{ti} \textbf{ma}ris:~* motum autem flúctuum \textit{e}\textit{jus} \textit{tu} \textbf{mí}\textbf{ti}gas.\\
...
{13.~}Thabor et Hermon in nómine tuo \textit{ex}\textit{sul}\textbf{tá}bunt:~* tuum bráchi\textit{um} \textit{cum} \textit{po}\textbf{tén}\textbf{ti}a.\\
...
{16.~}Dómine, in lúmine vultus tui ambulábunt,~† et in nómine tuo exsultábunt \textit{to}\textit{ta} \textbf{di}e:~* et in justítia tua \textit{e}\textit{xal}\textit{ta}\textbf{bún}tur.\\
...
{31.~}Si justítias meas \textit{pro}\textit{fa}\textbf{ná}verint:~* et mandáta mea \textit{non} \textit{cu}\textit{sto}\textbf{dí}\textbf{e}rint:\\
...
{49.~}Memor esto, Dómine, oppróbrii servó\textit{rum} \textit{tu}\textbf{ó}rum:~* (quod contínui in sinu meo) \textit{mul}\textit{tá}\textit{rum} \textbf{Gén}\textbf{ti}um.\\
