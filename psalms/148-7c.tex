...
{5.~}Quia ipse \textbf{di}xit, et \textbf{fa}cta sunt:~* ipse mandávit, \textbf{et} cre\textbf{á}ta sunt.\\
{6.~}Státuit ea in ætérnum, et in \textbf{sǽ}culum \textbf{sǽ}culi:~* præcéptum pósuit, et non \textbf{præ}te\textbf{rí}bit.\\
...
{12.~}Júvenes, et vírgines,~† senes cum junióribus laudent \textbf{no}men \textbf{Dó}mini:~* quia exaltátum est nomen \textbf{e}jus so\textbf{lí}us.\\
