{2.~}Sed in lege Dómini volúntas \textbf{e}jus,~* et in lege ejus meditábitur di\textit{e} \textit{ac} \textbf{no}cte.\\
...
{6.~}Ideo non resúrgent ímpii in ju\textbf{dí}cio:~* neque peccatóres in concíli\textit{o} \textit{ju}\textbf{stó}rum.\\
{7.~}Quóniam novit Dóminus viam ju\textbf{stó}rum:~* et iter impió\textit{rum} \textit{pe}\textbf{rí}bit.\\
