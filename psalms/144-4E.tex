{2.~}Per síngulos dies bene\textit{dí}\textit{cam} \textbf{ti}bi:~* et laudábo nomen tuum in sǽculum, et in \textit{sǽ}\textit{cu}\textit{lum} \textbf{sǽ}\textbf{cu}li.\\
...
{16.~}Oculi ómnium in te \textit{spe}\textit{rant}, \textbf{Dó}mine:~* et tu das escam illórum in témpo\textit{re} \textit{op}\textit{por}\textbf{tú}no.\\
{17.~}Aperis tu \textit{ma}\textit{num} \textbf{tu}am:~* et imples omne ánimal be\textit{ne}\textit{di}\textit{cti}\textbf{ó}ne.\\
...
{20.~}Voluntátem timéntium se fáciet:~† et deprecatiónem eó\textit{rum} \textit{e}\textbf{xáu}diet:~* et salvos \textit{fá}\textit{ci}\textit{et} \textbf{e}os.\\
{21.~}Custódit Dóminus omnes \textit{di}\textit{li}\textbf{gén}tes se:~* et omnes pecca\textit{tó}\textit{res} \textit{di}\textbf{spér}det.\\
