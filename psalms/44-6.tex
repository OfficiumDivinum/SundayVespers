{2.~}Lingua mea cála\textit{mus} \textbf{scri}bæ:~* velóci\textit{ter} \textit{scri}\textbf{bén}tis.\\
...
{17.~}Afferéntur in lætítia et exsulta\textit{ti}\textbf{ó}ne:~* adducéntur in \textit{tem}\textit{plum} \textbf{Re}gis.\\
