{2.~}Sit nomen Dómini \textit{be}\textit{ne}\textbf{dí}ctum,~* ex hoc nunc, et \textit{us}\textit{que} \textit{in} \textbf{sǽ}culum.\\
...
{6.~}Súscitans a \textit{ter}\textit{ra} \textbf{í}nopem,~* et de stércore \textit{é}\textit{ri}\textit{gens} \textbf{páu}perem:\\
