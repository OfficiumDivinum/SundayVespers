{2.~}Bonitátem et disciplínam et scién\textit{ti}\textit{am} \textbf{do}ce me:~* quia mandá\textit{tis} \textit{tu}\textit{is} \textbf{cré}\textbf{di}di.\\
{3.~}Priúsquam humiliárer e\textit{go} \textit{de}\textbf{lí}qui:~* proptérea elóquium tu\textit{um} \textit{cu}\textit{sto}\textbf{dí}vi.\\
...
{6.~}Coagulátum est sicut lac \textit{cor} \textit{e}\textbf{ó}rum:~* ego vero legem tu\textit{am} \textit{me}\textit{di}\textbf{tá}\textbf{tus} sum.\\
{7.~}Bonum mihi quia hu\textit{mi}\textit{li}\textbf{á}sti me:~* ut discam justifica\textit{ti}\textit{ó}\textit{nes} \textbf{tu}as.\\
...
{11.~}Cognóvi, Dómine, quia ǽquitas judí\textit{ci}\textit{a} \textbf{tu}a:~* et in veritáte tua \textit{hu}\textit{mi}\textit{li}\textbf{á}\textbf{sti} me.\\
...
{13.~}Véniant mihi miseratiónes tu\textit{æ}, \textit{et} \textbf{vi}vam:~* quia lex tua medi\textit{tá}\textit{ti}\textit{o} \textbf{me}\textbf{a} est.\\
