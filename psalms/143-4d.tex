{2.~}Misericórdia mea, et refú\textit{gi}\textit{um} \textbf{me}um:~* suscéptor meus, et li\textit{be}\textit{rá}\textit{tor} \textbf{me}us:\\
...
{5.~}Homo vanitáti sí\textit{mi}\textit{lis} \textbf{fa}ctus est:~* dies ejus sicut \textit{um}\textit{bra} \textit{præ}\textbf{té}reunt.\\
...
{12.~}Et érue me de manu filiórum alienórum,~† quorum os locútum est \textit{va}\textit{ni}\textbf{tá}tem:~* et déxtera eórum, déxtera \textit{i}\textit{ni}\textit{qui}\textbf{tá}tis.\\
...
{17.~}Non est ruína macériæ, \textit{ne}\textit{que} \textbf{trán}situs:~* neque clamor in pla\textit{té}\textit{is} \textit{e}\textbf{ó}rum.\\
