...
{3.~}Rénuit consolári ánima mea:~† memor fui Dei, et delectátus sum, et e\textbf{xer}ci\textbf{tá}\textbf{tus} sum:~* et defécit \textbf{spí}ritus \textbf{me}us.\\
...
{17.~}Etenim sagíttæ \textbf{tu}æ \textbf{trán}\textbf{se}unt:~* vox tonítrui \textbf{tu}i in \textbf{ro}ta.\\
