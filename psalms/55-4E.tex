{2.~}Conculcavérunt me inimíci mei \textit{to}\textit{ta} \textbf{di}e:~* quóniam multi bel\textit{lán}\textit{tes} \textit{ad}\textbf{vér}\textbf{sum} me.\\
...
{10.~}In quacúmque die invo\textit{cá}\textit{ve}\textbf{ro} te:~* ecce cognóvi quóni\textit{am} \textit{De}\textit{us} \textbf{me}\textbf{us} es.\\
...
{13.~}Quóniam eripuísti ánimam meam de morte, et pedes me\textit{os} \textit{de} \textbf{la}psu:~* ut pláceam coram Deo in lú\textit{mi}\textit{ne} \textit{vi}\textbf{vén}\textbf{ti}um.\\
