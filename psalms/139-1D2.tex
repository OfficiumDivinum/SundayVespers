...
{12.~}Vir linguósus non diri\textbf{gé}tur in \textbf{ter}ra:~* virum injústum mala cápient \textit{in} \textit{in}\textbf{té}\textbf{ri}tu.\\
{13.~}Cognóvi quia fáciet Dóminus ju\textbf{dí}cium \textbf{í}nopis:~* et vin\textit{dí}\textit{ctam} \textbf{páu}\textbf{pe}rum.\\
