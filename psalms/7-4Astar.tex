...
{11.~}Justum adjutórium me\textit{um} \textit{a} \textbf{Dó}mino,~* qui salvos fa\textit{cit} \textit{re}\textit{ctos} \textbf{cor}de.\\
...
{15.~}Ecce partúriit \textit{in}\textit{ju}\textbf{stí}tiam:~* concépit dolórem, et péperit \textit{i}\textit{ni}\textit{qui}\textbf{tá}tem.\\
