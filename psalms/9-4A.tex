...
{4.~}Quóniam fecísti judícium meum et \textit{cau}\textit{sam} \textbf{me}am:~* sedísti super thronum, qui jú\textit{di}\textit{cas} \textit{ju}\textbf{stí}tiam.\\
{5.~}Increpásti Gentes, et pé\textit{ri}\textit{it} \textbf{ím}pius:~* nomen eórum delésti in ætérnum, et in \textit{sǽ}\textit{cu}\textit{lum} \textbf{sǽ}culi.\\
...
{8.~}Parávit in judício \textit{thro}\textit{num} \textbf{su}um:~* et ipse judicábit orbem terræ in æquitáte, judicábit pópu\textit{los} \textit{in} \textit{ju}\textbf{stí}tia.\\
...
{16.~}In láqueo isto, quem \textit{ab}\textit{scon}\textbf{dé}runt,~* comprehénsus \textit{est} \textit{pes} \textit{e}\textbf{ó}rum.\\
...
{26.~}Non est Deus in con\textit{spé}\textit{ctu} \textbf{e}jus:~* inquinátæ sunt viæ illíus \textit{in} \textit{om}\textit{ni} \textbf{tém}pore.\\
...
{35.~}Exsúrge, Dómine Deus, exaltétur \textit{ma}\textit{nus} \textbf{tu}a:~* ne obli\textit{vi}\textit{scá}\textit{ris} \textbf{páu}perum.\\
