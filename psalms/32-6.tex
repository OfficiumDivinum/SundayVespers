...
{18.~}Ecce óculi Dómini super metuén\textit{tes} \textbf{e}um:~* et in eis, qui sperant super misericór\textit{di}\textit{a} \textbf{e}jus:\\
{19.~}Ut éruat a morte ánimas \textit{e}\textbf{ó}rum:~* et alat e\textit{os} \textit{in} \textbf{fa}me.\\
{20.~}Anima nostra sústi\textit{net} \textbf{Dó}minum:~* quóniam adjútor et pro\textit{té}\textit{ctor} \textbf{no}ster est.\\
{21.~}Quia in eo lætábitur \textit{cor} \textbf{no}strum:~* et in nómine sancto e\textit{jus} \textit{spe}\textbf{rá}vimus.\\
