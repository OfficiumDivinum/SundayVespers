{2.~}In die tribulatiónis meæ Deum exquisívi,~† mánibus meis nocte \textbf{con}tra \textbf{e}um:~* et non \textit{sum} \textit{de}\textbf{cép}tus.\\
...
{13.~}Deus, in sancto via tua:~† quis Deus magnus sicut \textbf{De}us \textbf{no}ster?~* tu es Deus qui facis \textit{mi}\textit{ra}\textbf{bí}\textbf{li}a.\\
