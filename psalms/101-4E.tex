{2.~}Non avértas fáciem \textit{tu}\textit{am} \textbf{a} me:~* in quacúmque die tríbulor, inclína ad \textit{me} \textit{au}\textit{rem} \textbf{tu}am.\\
{3.~}In quacúmque die invo\textit{cá}\textit{ve}\textbf{ro} te:~* veló\textit{ci}\textit{ter} \textit{e}\textbf{xáu}\textbf{di} me.\\
...
{11.~}A fácie iræ et indignati\textit{ó}\textit{nis} \textbf{tu}æ:~* quia éle\textit{vans} \textit{al}\textit{li}\textbf{sí}\textbf{sti} me.\\
{12.~}Dies mei sicut umbra de\textit{cli}\textit{na}\textbf{vé}runt:~* et ego si\textit{cut} \textit{fœ}\textit{num} \textbf{á}\textbf{ru}i.\\
...
{17.~}Quia ædificávit Dó\textit{mi}\textit{nus} \textbf{Si}on:~* et vidébitur in \textit{gló}\textit{ri}\textit{a} \textbf{su}a.\\
