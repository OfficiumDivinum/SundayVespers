...
{15.~}Oculi Dómini \textit{su}\textit{per} \textbf{ju}stos:~* et aures ejus in \textit{pre}\textit{ces} \textit{e}\textbf{ó}rum.\\
...
{19.~}Multæ tribulatió\textit{nes} \textit{ju}\textbf{stó}rum:~* et de ómnibus his liberá\textit{bit} \textit{e}\textit{os} \textbf{Dó}\textbf{mi}nus.\\
{20.~}Custódit Dóminus ómnia os\textit{sa} \textit{e}\textbf{ó}rum:~* unum ex his \textit{non} \textit{con}\textit{te}\textbf{ré}tur.\\
{21.~}Mors pecca\textit{tó}\textit{rum} \textbf{pés}sima:~* et qui odérunt \textit{ju}\textit{stum}, \textit{de}\textbf{lín}quent.\\
