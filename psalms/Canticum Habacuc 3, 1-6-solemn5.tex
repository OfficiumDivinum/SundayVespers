{2.~}Dómine, o\textit{pus} \textbf{tu}um,~* in médio annórum vi\textit{ví}\textit{fi}\textit{ca} \textbf{il}lud:\\
...
{9.~}Aspéxit, et dissól\textit{vit} \textbf{Gen}tes:~* et contríti \textit{sunt} \textit{mon}\textit{tes} \textbf{sæ}culi;\\
{10.~}Incurváti sunt col\textit{les} \textbf{mun}di,~* ab itinéribus æ\textit{ter}\textit{ntá}\textit{tis} \textbf{e}jus.\\
