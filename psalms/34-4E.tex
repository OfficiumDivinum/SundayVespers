...
{13.~}Surgéntes te\textit{stes} \textit{i}\textbf{ní}qui,~* quæ ignorábam \textit{in}\textit{ter}\textit{ro}\textbf{gá}\textbf{bant} me.\\
{14.~}Retribuébant mihi ma\textit{la} \textit{pro} \textbf{bo}nis:~* sterilitátem \textit{á}\textit{ni}\textit{mæ} \textbf{me}æ.\\
{15.~}Ego autem cum mihi mo\textit{lé}\textit{sti} \textbf{es}sent,~* indu\textit{é}\textit{bar} \textit{ci}\textbf{lí}\textbf{ci}o.\\
...
{22.~}Non supergáudeant mihi qui adversántur mi\textit{hi} \textit{i}\textbf{ní}que:~* qui odérunt me gratis et \textit{án}\textit{nu}\textit{unt} \textbf{ó}\textbf{cu}lis.\\
