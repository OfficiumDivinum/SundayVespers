...
{5.~}Irascímini, et nolíte peccáre:~† quæ dícitis in cór\textit{di}\textit{bus} \textbf{ve}stris,~* in cubílibus ve\textit{stris} \textit{com}\textit{pun}\textbf{gí}\textbf{mi}ni.\\
...
{10.~}Quóniam tu, Dómine, singulá\textit{ri}\textit{ter} \textbf{in} spe~* \textit{con}\textit{sti}\textit{tu}\textbf{í}\textbf{sti} me.\\
