{2.~}Dómine, Deus meus, cla\textit{má}\textit{vi} \textbf{ad} te,~* \textit{et} \textit{sa}\textbf{ná}\textbf{sti} me.\\
...
{6.~}Ad vésperum demorá\textit{bi}\textit{tur} \textbf{fle}tus:~* et ad matu\textit{tí}\textit{num} \textit{læ}\textbf{tí}\textbf{ti}a.\\
...
{14.~}Convertísti planctum meum in gáu\textit{di}\textit{um} \textbf{mi}hi:~* conscidísti saccum meum, et circumdedí\textit{sti} \textit{me} \textit{læ}\textbf{tí}\textbf{ti}a:\\
