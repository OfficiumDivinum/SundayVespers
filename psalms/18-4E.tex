{2.~}Dies diéi e\textit{rú}\textit{ctat} \textbf{ver}bum,~* et nox nocti ín\textit{di}\textit{cat} \textit{sci}\textbf{én}\textbf{ti}am.\\
...
{14.~}Si mei non fúerint domináti, tunc immacu\textit{lá}\textit{tus} \textbf{e}ro:~* et emundábor a \textit{de}\textit{lí}\textit{cto} \textbf{má}\textbf{xi}mo.\\
