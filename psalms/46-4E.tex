{2.~}Quóniam Dóminus excél\textit{sus}, \textit{ter}\textbf{rí}bilis:~* Rex magnus su\textit{per} \textit{om}\textit{nem} \textbf{ter}ram.\\
{3.~}Subjécit pó\textit{pu}\textit{los} \textbf{no}bis:~* et Gentes sub \textit{pé}\textit{di}\textit{bus} \textbf{no}stris.\\
...
{6.~}Psállite Deo \textit{no}\textit{stro}, \textbf{psál}lite:~* psállite Re\textit{gi} \textit{no}\textit{stro}, \textbf{psál}\textbf{li}te.\\
{7.~}Quóniam Rex omnis \textit{ter}\textit{ræ} \textbf{De}us:~* psálli\textit{te} \textit{sa}\textit{pi}\textbf{én}ter.\\
{8.~}Regnábit Deus \textit{su}\textit{per} \textbf{Gen}tes:~* Deus sedet super se\textit{dem} \textit{san}\textit{ctam} \textbf{su}am.\\
