{2.~}Et immítte timórem tu\textit{um} \textit{su}\textit{per} \textbf{gen}tes,~* quæ non ex\textit{qui}\textit{si}\textbf{é}\textbf{runt} te,\\
...
{6.~}Ut cognóscant te, sicut \textit{et} \textit{nos} \textit{co}\textbf{gnó}\textbf{vi}mus,~* quóniam non est Deus præ\textit{ter} \textit{te}, \textbf{Dó}\textbf{mi}ne.\\
...
{11.~}Cóntere caput príncipum \textit{i}\textit{ni}\textit{mi}\textbf{có}rum,~* dicéntium: Non est á\textit{li}\textit{us} \textbf{præ}\textbf{ter} nos.\\
...
{13.~}Et here\textit{di}\textit{tá}\textit{bis} \textbf{e}os,~* sicut \textit{ab} \textit{i}\textbf{ní}\textbf{ti}o.\\
