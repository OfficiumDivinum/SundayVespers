{2.~}Gloriósa \textbf{di}cta sunt \textbf{de} te,~* cí\textit{vi}\textit{tas} \textbf{De}i.\\
...
{5.~}Numquid Sion dicet:~† Homo, et homo natus \textbf{est} in \textbf{e}a:~* et ipse fundávit e\textit{am} \textit{Al}\textbf{tís}simus?\\
