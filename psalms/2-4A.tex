{2.~}Astitérunt reges terræ, et príncipes convené\textit{runt} \textit{in} \textbf{u}num~* advérsus Dóminum, et advér\textit{sus} \textit{Chri}\textit{stum} \textbf{e}jus.\\
{3.~}Dirumpámus víncu\textit{la} \textit{e}\textbf{ó}rum:~* et projiciámus a nobis \textit{ju}\textit{gum} \textit{i}\textbf{psó}rum.\\
...
{6.~}Ego autem constitútus sum Rex ab eo super Sion montem \textit{san}\textit{ctum} \textbf{e}jus,~* prǽdicans \textit{præ}\textit{cép}\textit{tum} \textbf{e}jus.\\
...
{12.~}Apprehéndite disciplínam, nequándo ira\textit{scá}\textit{tur} \textbf{Dó}minus,~* et pereátis \textit{de} \textit{vi}\textit{a} \textbf{ju}sta.\\
