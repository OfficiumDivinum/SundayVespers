...
{5.~}Quia ipse dixit, \textit{et} \textbf{fa}cta sunt:~* ipse mandávit, \textit{et} \textit{cre}\textbf{á}ta sunt.\\
{6.~}Státuit ea in ætérnum, et in sǽcu\textit{lum} \textbf{sǽ}culi:~* præcéptum pósuit, et non \textit{præ}\textit{te}\textbf{rí}bit.\\
...
{12.~}Júvenes, et vírgines,~† senes cum junióribus laudent no\textit{men} \textbf{Dó}mini:~* quia exaltátum est nomen e\textit{jus} \textit{so}\textbf{lí}us.\\
{13.~}Conféssio ejus super cælum \textit{et} \textbf{ter}ram:~* et exaltávit cornu pó\textit{pu}\textit{li} \textbf{su}i.\\
{14.~}Hymnus ómnibus san\textit{ctis} \textbf{e}jus:~* fíliis Israël, pópulo appropin\textit{quán}\textit{ti} \textbf{si}bi.\\
