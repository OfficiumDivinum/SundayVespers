...
{4.~}Beátus, cujus Deus Jacob adjútor ejus,~† spes ejus in Dómino \textbf{De}o i\textbf{psí}us:~* qui fecit cælum et terram, mare et ómnia, \textit{quæ} \textit{in} \textbf{e}is sunt.\\
{5.~}Qui custódit veritátem in sǽculum,~† facit judícium injúriam \textbf{pa}ti\textbf{én}tibus:~* dat escam e\textit{su}\textit{ri}\textbf{én}tibus.\\
