{2.~}Magna \textbf{ó}pera \textbf{Dó}\textbf{mi}ni:~* exquisíta in omnes volun\textbf{tá}tes \textbf{e}jus.\\
{3.~}Conféssio et magnificéntia \textbf{o}pus \textbf{e}jus:~* et justítia ejus manet in \textbf{sǽ}culum \textbf{sǽ}culi.\\
{4.~}Memóriam fecit mirabílium suórum,~† miséricors et mise\textbf{rá}tor \textbf{Dó}\textbf{mi}nus:~* escam dedit ti\textbf{mén}ti\textbf{bus} se.\\
...
{7.~}Fidélia ómnia mandáta ejus:~† confirmáta in \textbf{sǽ}culum \textbf{sǽ}\textbf{cu}li,~* facta in veritáte et \textbf{æ}qui\textbf{tá}te.\\
