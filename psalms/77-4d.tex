{2.~}Apériam in parábo\textit{lis} \textit{os} \textbf{me}um:~* loquar propositió\textit{nes} \textit{ab} \textit{i}\textbf{ní}tio.\\
...
{10.~}Ne fiant sicut pa\textit{tres} \textit{e}\textbf{ó}rum:~* generátio pra\textit{va} \textit{et} \textit{e}\textbf{xá}sperans.\\
...
{25.~}Ideo audívit Dómi\textit{nus}, \textit{et} \textbf{dí}stulit:~* et ignis accénsus est in Jacob, et ira a\textit{scén}\textit{dit} \textit{in} \textbf{Is}raël.\\
...
{29.~}Panem Angelórum mandu\textit{cá}\textit{vit} \textbf{ho}mo,~* cibária misit eis \textit{in} \textit{a}\textit{bun}\textbf{dán}tia.\\
{30.~}Tránstulit Au\textit{strum} \textit{de} \textbf{cæ}lo:~* et indúxit in virtú\textit{te} \textit{su}\textit{a} \textbf{A}fricum.\\
...
{39.~}Et rememoráti sunt quia Deus adjútor \textit{est} \textit{e}\textbf{ó}rum:~* et Deus excélsus re\textit{dém}\textit{ptor} \textit{e}\textbf{ó}rum est.\\
...
{44.~}Et recordátus est \textit{qui}\textit{a} \textbf{ca}ro sunt:~* spíritus va\textit{dens} \textit{et} \textit{non} \textbf{ré}diens.\\
{45.~}Quóties exacerbavérunt eum \textit{in} \textit{de}\textbf{sér}to,~* in iram concitavérunt eum \textit{in} \textit{i}\textit{na}\textbf{quó}so?\\
